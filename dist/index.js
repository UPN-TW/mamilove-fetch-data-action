...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(787)("follow-redirects");
    }
    catch (error) { /* */ }
...
module.exports = __nccwpck_require__(2507)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __nccwpck_require__(4004);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(2369);
} else {
	module.exports = __nccwpck_require__(2296);
}
...
try {
	...
	const supportsColor = __nccwpck_require__(8106);
...
const hasFlag = __nccwpck_require__(8379);
...
;// CONCATENATED MODULE: ./src/api/request.ts

const request = axios_default().create({
    baseURL: 'https://mamilove.com.tw'
});
/* harmony default export */ const api_request = (request);

;// CONCATENATED MODULE: ./src/api/mall/transform.ts
const matchPattern = {
    curation: '/market/category/event',
    groupbuy: '/groupbuy'
};
const transformCuration = (apiResponse) => {
...
const transformGroupbuy = (apiResponse) => {
    const data = apiResponse.data;
    const latestEvents = data.groupbuyCurations[0].data;
    const eventPaths = latestEvents.map(event => event.path);
...
;// CONCATENATED MODULE: ./src/api/mall/api.ts
...
const fetchLatestCuration = () => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield api_request.get('/resource/mall/all');
    return transformCuration(data);
});
const fetchLatestGroupbuy = () => __awaiter(void 0, void 0, void 0, function* () {
    const { data } = yield api_request.get('/resource/mall/all');
...
const actionsMap = {
    ["latest-groupbuy" /* LATEST_GROUPBUY */]: fetchLatestGroupbuy,
    ["latest-curation" /* LATEST_CURATION */]: fetchLatestCuration,
};
const main = () => src_awaiter(void 0, void 0, void 0, function* () {
    if (!actionsMap[actionType])
        return core.setFailed('Invalid action type');
    try {
        const result = yield actionsMap[actionType]();
